...
//导入html-webpack-plugin  用于打包生成html文件
...
module.exports = {
   ...
   module: {
    ...
    // resolve部分主要用来处理一些路径问题  扩张名问题
   resolve: {
        // ** 引入vue文件时需要更改vue文件指向
       extensions:['.js','.vue','.css',],   //表示这些文件在引用时 后缀名可以省略不写
        alias: {
    ...
    plugins:[
        new WebPack.BannerPlugin("版权归蒋良吉所有"),
        new HtmlWebpackPlugin({
            template:'index.栈'  //根据模板来生成index.html文件
        })
    ],
};